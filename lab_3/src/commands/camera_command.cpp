...
RotateCameraCommand::RotateCameraCommand(const size_t &camera_num, const double &ox, const double &oy, const double &oz) :
	_camera_num(camera_num), _ox(ox), _oy(oy), _oz(oz) { }
