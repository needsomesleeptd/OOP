...
class RotateCameraCommand : public CameraBaseCommand
{
 public:
	explicit RotateCameraCommand() = default;
	RotateCameraCommand(const size_t &camera_num, const double &ox, const double &oy, const double &oz);
