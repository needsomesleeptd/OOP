...
void rotate_OX_dot(dot_t &dot, dot_t &center_of_rotation, rotator_t &rotator)
{
...
void  rotate_OY_dot(dot_t &dot, dot_t &center_of_rotation, rotator_t &rotator)
{
...
void  rotate_OZ_dot(dot_t &dot, dot_t &center_of_rotation, rotator_t &rotator)
{
...
{
	rotate_OX_dot(dot,center_of_rotation,rotator);
	rotate_OY_dot(dot,center_of_rotation,rotator);
	rotate_OZ_dot(dot,center_of_rotation,rotator);
}

void rotate_dots(dot_array_t array, dot_t &center_of_rotation, rotator_t &rotator)
{
	for (int i = 0; i < array.len; i++)
		rotate_dot(array.dots[i], center_of_rotation,rotator);
}